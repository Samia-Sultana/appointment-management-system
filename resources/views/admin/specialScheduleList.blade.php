            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <h4>Special Schedule List</h4>
                        <h6>Manage your schedule</h6>
                    </div>
                    <div class="page-btn">
                        <a href="{{route('admin.specialPage')}}" class="btn btn-added"><img src="{{asset('assets/img/icons/plus.svg')}}" alt="img" class="me-1">Add chember</a>
                    </div>
                </div>
